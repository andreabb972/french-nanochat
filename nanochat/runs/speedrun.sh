...
export NANOCHAT_BASE_DIR="$HOME/.cache/nanochat_K_50tok"
...
torchrun --standalone --nproc_per_node=1 -m scripts.c2_1c_chat_sft -- --device-batch-size=16 --run=$WANDB_RUN
